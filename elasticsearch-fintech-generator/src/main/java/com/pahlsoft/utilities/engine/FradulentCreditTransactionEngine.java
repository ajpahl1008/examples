...
public class FradulentCreditTransactionEngine implements TransactionEngine {
    ...
    public FradulentCreditTransactionEngine() throws Exception {
        this.loadProperties();
    }
    ...
    public void run() {
        ...
        log.info("Starting Fraudulent Credit Card Transaction Engine " + Thread.currentThread().getId());
        ...
        while(true) {
            ...
            try {
                Thread.sleep(randomSleepTime(100000,300000));
